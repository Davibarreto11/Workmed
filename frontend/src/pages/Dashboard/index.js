        ...
        <FlexBox>
            ...
            <div className="bot">
              {doctor01?.map((doctor) => (
                <div key={doctor?.id}>
                  <h4>
                    <p>{doctor?.name}</p>
                    <span style={{ color: '#FF7723' }}>{doctor?.speciality}</span>
                  </h4>
          ...
          <Box>
            ...
            <div className="bot">
              <div style={{ maxWidth: 245 }}>
                ...
                <p>
                  Entre nosso pacientes:
                  {' '}
                  <span style={{ color: '#308ECC' }}>{medicHistoric.maxmedic}</span>
                </p>
              </div>
              <div>
          ...
          <BoxWeather>
            ...
            <div className="bot">
              <div>
                <h4>
                  <span style={{ color: '#27AE60' }}>{surgeryToday}</span>
                  {' '}
                  Cirurgias
                </h4>
          ...
          <div className="top">
            ...
            <div className="">
              <h4>
                ...
                {' '}
                {totalExpenses3Months}
                ,
                <span style={{ color: '#16A085' }}>00</span>
              </h4>
            </div>
          </div>
          <div>
